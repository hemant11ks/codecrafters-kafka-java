...
public sealed interface Header {
	...
	public record V0(int correlationId) implements Header{
	...
	public record V1(int correlationId) implements Header{
	...
	public record V2(RequestApi requestApi,int correlationId,String clientId) implements Header {
		...
		public static V2 deserialize(DataInput input) {
			final var requestApi = RequestApi.of(input.readSignedShort(), input.readSignedShort());
