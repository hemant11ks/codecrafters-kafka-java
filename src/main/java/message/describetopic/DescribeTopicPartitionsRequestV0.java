...
public record DescribeTopicPartitionsRequestV0(List<DescribeTopicPartitionsRequestV0.Topic> topics,
		int responsePartitionLimit, DescribeTopicPartitionCursorV0 nextCursor) implements RequestBody {
	...
	public record Topic(String name) {
		...
		public static DescribeTopicPartitionsRequestV0.Topic deserialize(DataInput input){
			...
			return new DescribeTopicPartitionsRequestV0.Topic(name);
		}
	}
