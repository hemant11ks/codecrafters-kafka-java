...
public record FetchRequestV16(Duration maxWait ,
		int minBytes,
		int maxBytes ,
		byte isolationLevel,
		int sessionId,
		int sessionEpoch,
		List<Topic> topics, 
		List<ForgottenTopicsData> forgottenTopicData,
	...
	public record Topic( UUID topicId  , List<Partition> partitons) {
	...
	public record Partition( int partition,
